  ...
  return (
    <LoggedInContainer curActiveScreen="search">
        <div className='w-full py-6 '>
            <div className={`w-1/3 p-3 text-sm rounded-full bg-gray-800 px-5 text-white flex space-x-3 items-center ${isInputFocused?"border border-white":""}`}>
                <div><Icon icon="ic:outline-search" className='text-lg '/></div>
                <input 
                type='text' 
